...
<template>
    <ActionSection>
        ...
        <template #description>
            {{ $t('profile.manage_and_log_out_your_active_sessions_on_other_browsers_and_devices') }}
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                {{ $t('profile.if_necessary') }}
            </div>
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout" :style="{'background-color': colorStore.color}" >
                    {{ $t('profile.log_out_other_browser_sessions') }}
                </PrimaryButton>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    {{ $t('profile.please_enter_your_password_to_confirm') }}
